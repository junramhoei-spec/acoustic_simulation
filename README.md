...
이 프로젝트는 **물 채움 시 수위 변화에 따른 음향 공명 주파수(Dip Spectrum / Ratio Transfer Function)** 데이터를 기반으로 컵의 **높이($) 및 3D 반지름 프로파일((z)$)**을 역추적하는 딥러닝 프레임워크입니다.
